...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feedback_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.Category'])),
            ('common_issue', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal('feedback', ['Article'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('feedback_article')
    ...
    models = {
        ...
        'feedback.article': {
            ...
            'common_issue': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
