...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestRunResult.response'
        db.alter_column('heartbeat_testrunresult', 'response', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'TestRunResult.response'
        db.alter_column('heartbeat_testrunresult', 'response', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
