...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeoWidget.url'
        db.alter_column(u'operations_geowidget', 'url', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'GeoWidget.url'
        db.alter_column(u'operations_geowidget', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
