...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.show_timeline'
        db.add_column('operations_event', 'show_timeline',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Event.show_services'
        db.add_column('operations_event', 'show_services',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Event.show_notes'
        db.add_column('operations_event', 'show_notes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Event.show_products'
        db.add_column('operations_event', 'show_products',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Event.show_rfis'
        db.add_column('operations_event', 'show_rfis',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.show_timeline'
        db.delete_column('operations_event', 'show_timeline')

        # Deleting field 'Event.show_services'
        db.delete_column('operations_event', 'show_services')

        # Deleting field 'Event.show_notes'
        db.delete_column('operations_event', 'show_notes')

        # Deleting field 'Event.show_products'
        db.delete_column('operations_event', 'show_products')

        # Deleting field 'Event.show_rfis'
        db.delete_column('operations_event', 'show_rfis')
    ...
    models = {
        ...
        'operations.event': {
            ...
            'show_incident_on_map': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
