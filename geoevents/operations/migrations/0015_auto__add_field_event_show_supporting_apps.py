...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.show_supporting_apps'
        db.add_column('operations_event', 'show_supporting_apps',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.show_supporting_apps'
        db.delete_column('operations_event', 'show_supporting_apps')
