...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('operations_event', 'product_feed_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Event.product_feed_url'
        db.alter_column('operations_event', 'product_feed_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
