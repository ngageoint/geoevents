...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.gq_project_ids'
        db.delete_column(u'operations_event', 'gq_project_ids')

        # Deleting field 'Event.gq_job_ids'
        db.delete_column(u'operations_event', 'gq_job_ids')

        # Adding field 'Event.standard_product_url'
        db.add_column(u'operations_event', 'standard_product_url',
                      self.gf('django.db.models.fields.TextField')(max_length=800, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.gq_project_ids'
        db.add_column(u'operations_event', 'gq_project_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.gq_job_ids'
        db.add_column(u'operations_event', 'gq_job_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.standard_product_url'
        db.delete_column(u'operations_event', 'standard_product_url')
    ...
    models = {
        ...
        u'operations.event': {
            ...
            'standard_product_url': ('django.db.models.fields.TextField', [], {'max_length': '800', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '1'}),
