...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeoWidget.tabToOpenIn'
        db.add_column(u'operations_geowidget', 'tabToOpenIn',
                      self.gf('django.db.models.fields.CharField')(default='_new', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoWidget.selectorShowIf'
        db.add_column(u'operations_geowidget', 'selectorShowIf',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoWidget.style'
        db.add_column(u'operations_geowidget', 'style',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeoWidget.tabToOpenIn'
        db.delete_column(u'operations_geowidget', 'tabToOpenIn')

        # Deleting field 'GeoWidget.selectorShowIf'
        db.delete_column(u'operations_geowidget', 'selectorShowIf')

        # Deleting field 'GeoWidget.style'
        db.delete_column(u'operations_geowidget', 'style')
