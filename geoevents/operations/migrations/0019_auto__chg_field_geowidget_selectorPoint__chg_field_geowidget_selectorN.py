...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeoWidget.selectorPoint'
        db.alter_column('operations_geowidget', 'selectorPoint', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'GeoWidget.selectorName'
        db.alter_column('operations_geowidget', 'selectorName', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'GeoWidget.selectorLink'
        db.alter_column('operations_geowidget', 'selectorLink', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'GeoWidget.selectorSummary'
        db.alter_column('operations_geowidget', 'selectorSummary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'GeoWidget.selectorPoint'
        db.alter_column('operations_geowidget', 'selectorPoint', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'GeoWidget.selectorName'
        db.alter_column('operations_geowidget', 'selectorName', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'GeoWidget.selectorLink'
        db.alter_column('operations_geowidget', 'selectorLink', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'GeoWidget.selectorSummary'
        db.alter_column('operations_geowidget', 'selectorSummary', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
