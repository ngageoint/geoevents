...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GeoWidget'
        db.create_table('operations_geowidget', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('url_if_local', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('below_zoom', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('above_zoom', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('listName', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('selectorName', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('selectorLink', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('selectorPoint', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('selectorSummary', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('data_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('operations', ['GeoWidget'])

        # Adding M2M table for field geowidgets on 'Event'
        db.create_table('operations_event_geowidgets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['operations.event'], null=False)),
            ('geowidget', models.ForeignKey(orm['operations.geowidget'], null=False))
        ))
        db.create_unique('operations_event_geowidgets', ['event_id', 'geowidget_id'])


    def backwards(self, orm):
        # Deleting model 'GeoWidget'
        db.delete_table('operations_geowidget')

        # Removing M2M table for field geowidgets on 'Event'
        db.delete_table('operations_event_geowidgets')
    ...
    models = {
        ...
        'operations.event': {
            ...
            'geowidgets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['operations.GeoWidget']", 'null': 'True', 'blank': 'True'}),
        ...
        'operations.geowidget': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'selectorLink': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'selectorName': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'selectorPoint': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'selectorSummary': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'url_if_local': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
