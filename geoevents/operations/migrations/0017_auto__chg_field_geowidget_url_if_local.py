...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeoWidget.url_if_local'
        db.alter_column('operations_geowidget', 'url_if_local', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'GeoWidget.url_if_local'
        db.alter_column('operations_geowidget', 'url_if_local', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
