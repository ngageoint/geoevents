...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('operations_event', 'gq_project_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.gq_job_ids'
        db.add_column('operations_event', 'gq_job_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('operations_event', 'gq_project_ids')

        # Deleting field 'Event.gq_job_ids'
        db.delete_column('operations_event', 'gq_job_ids')
