...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.filedropoff_path'
        db.add_column('operations_event', 'filedropoff_path',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.filedropoff_path'
        db.delete_column('operations_event', 'filedropoff_path')
