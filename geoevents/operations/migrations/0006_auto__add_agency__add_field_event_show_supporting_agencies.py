...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Agency'
        db.create_table('operations_agency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('logo', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('operations', ['Agency'])

        # Adding field 'Event.show_supporting_agencies'
        db.add_column('operations_event', 'show_supporting_agencies',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field agencies on 'Event'
        db.create_table('operations_event_agencies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['operations.event'], null=False)),
            ('agency', models.ForeignKey(orm['operations.agency'], null=False))
        ))
        db.create_unique('operations_event_agencies', ['event_id', 'agency_id'])


    def backwards(self, orm):
        # Deleting model 'Agency'
        db.delete_table('operations_agency')

        # Deleting field 'Event.show_supporting_agencies'
        db.delete_column('operations_event', 'show_supporting_agencies')

        # Removing M2M table for field agencies on 'Event'
        db.delete_table('operations_event_agencies')
