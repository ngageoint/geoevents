...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table(u'director_report', (
            ...
            ('posted_by', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'director', ['Report'])

        # Adding M2M table for field related_boards on 'Report'
        m2m_table_name = db.shorten_name(u'director_report_related_boards')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'director.report'], null=False)),
            ('directordashboard', models.ForeignKey(orm[u'director.directordashboard'], null=False))
        ))
        db.create_unique(m2m_table_name, ['report_id', 'directordashboard_id'])

        # Adding M2M table for field related_programs on 'Report'
        m2m_table_name = db.shorten_name(u'director_report_related_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'director.report'], null=False)),
            ('programinfo', models.ForeignKey(orm[u'director.programinfo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['report_id', 'programinfo_id'])

        # Adding M2M table for field related_links on 'Report'
        m2m_table_name = db.shorten_name(u'director_report_related_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'director.report'], null=False)),
            ('link', models.ForeignKey(orm[u'director.link'], null=False))
        ))
        db.create_unique(m2m_table_name, ['report_id', 'link_id'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table(u'director_report')

        # Removing M2M table for field related_boards on 'Report'
        db.delete_table(db.shorten_name(u'director_report_related_boards'))

        # Removing M2M table for field related_programs on 'Report'
        db.delete_table(db.shorten_name(u'director_report_related_programs'))

        # Removing M2M table for field related_links on 'Report'
        db.delete_table(db.shorten_name(u'director_report_related_links'))
    ...
    models = {
        ...
        u'director.report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'posted_by': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
