...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DirectorDashboard'
        db.create_table(u'director_directordashboard', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='MapView', max_length=10)),
            ('site_icon', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'director', ['DirectorDashboard'])


    def backwards(self, orm):
        # Deleting model 'DirectorDashboard'
        db.delete_table(u'director_directordashboard')
