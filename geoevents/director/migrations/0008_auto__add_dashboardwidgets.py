...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DashboardWidgets'
        db.create_table(u'director_dashboardwidgets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['director.DirectorDashboard'])),
            ('widget', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['director.PageWidget'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'director', ['DashboardWidgets'])
    ...
    def backwards(self, orm):
        # Deleting model 'DashboardWidgets'
        db.delete_table(u'director_dashboardwidgets')
