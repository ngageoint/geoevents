...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgramInfo'
        db.create_table(u'director_programinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('management_poc', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'director', ['ProgramInfo'])


        # Changing field 'PageWidget.subtext'
        db.alter_column(u'director_pagewidget', 'subtext', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    def backwards(self, orm):
        # Deleting model 'ProgramInfo'
        db.delete_table(u'director_programinfo')


        # Changing field 'PageWidget.subtext'
        db.alter_column(u'director_pagewidget', 'subtext', self.gf('django.db.models.fields.CharField')(max_length=30))
