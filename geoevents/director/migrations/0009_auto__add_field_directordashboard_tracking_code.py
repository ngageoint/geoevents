...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DirectorDashboard.tracking_code'
        db.add_column(u'director_directordashboard', 'tracking_code',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DirectorDashboard.tracking_code'
        db.delete_column(u'director_directordashboard', 'tracking_code')
