...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.dashboard'
        db.add_column(u'director_link', 'dashboard',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['director.DirectorDashboard'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field links on 'DirectorDashboard'
        db.delete_table(db.shorten_name(u'director_directordashboard_links'))


    def backwards(self, orm):
        # Deleting field 'Link.dashboard'
        db.delete_column(u'director_link', 'dashboard_id')

        # Adding M2M table for field links on 'DirectorDashboard'
        m2m_table_name = db.shorten_name(u'director_directordashboard_links')
        ...
        db.create_unique(m2m_table_name, ['directordashboard_id', 'link_id'])
    ...
    models = {
        ...
        u'director.link': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dashboard': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['director.DirectorDashboard']", 'null': 'True', 'blank': 'True'}),
