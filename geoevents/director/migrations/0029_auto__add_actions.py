...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'director_actions', (
            ...
            ('action_id', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('originator', self.gf('django.db.models.fields.related.ForeignKey')(max_length=250, to=orm['auth.User'], null=True, blank=True)),
            ('date_assigned', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('date_plan_due', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('date_final_due', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('date_closed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('assigned_to', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2, max_length=1)),
            ('action_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('response', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('current_status', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('owning_organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['director.DirectorDashboard'], null=True, blank=True)),
        ))
        db.send_create_signal(u'director', ['Actions'])


    def backwards(self, orm):
        # Deleting model 'Actions'
        db.delete_table(u'director_actions')
    ...
    models = {
        ...
        u'director.actions': {
            'Meta': {'ordering': "['-date_final_due']", 'object_name': 'Actions'},
            ...
            'date_assigned': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'date_closed': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'date_final_due': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'date_plan_due': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
