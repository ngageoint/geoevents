...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DashboardWidgets.data_json_org'
        db.add_column(u'director_dashboardwidgets', 'data_json_org',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DashboardWidgets.data_json_org'
        db.delete_column(u'director_dashboardwidgets', 'data_json_org')
    ...
    models = {
        ...
        u'director.pagewidget': {
            ...
            'theme': ('django.db.models.fields.CharField', [], {'default': "'Thick'", 'max_length': '10'}),
