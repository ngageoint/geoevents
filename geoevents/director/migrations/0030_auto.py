...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_actions on 'Report'
        m2m_table_name = db.shorten_name(u'director_report_related_actions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'director.report'], null=False)),
            ('actions', models.ForeignKey(orm[u'director.actions'], null=False))
        ))
        db.create_unique(m2m_table_name, ['report_id', 'actions_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_actions on 'Report'
        db.delete_table(db.shorten_name(u'director_report_related_actions'))
