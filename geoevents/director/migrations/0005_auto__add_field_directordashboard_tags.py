...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DirectorDashboard.tags'
        db.add_column(u'director_directordashboard', 'tags',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DirectorDashboard.tags'
        db.delete_column(u'director_directordashboard', 'tags')
