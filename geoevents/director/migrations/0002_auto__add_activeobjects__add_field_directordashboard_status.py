...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DirectorDashboard.status'
        db.add_column(u'director_directordashboard', 'status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DirectorDashboard.status'
        db.delete_column(u'director_directordashboard', 'status')
    ...
    models = {
        ...
        u'director.activeobjects': {
            'Meta': {'object_name': 'ActiveObjects'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'director.directordashboard': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'MapView'", 'max_length': '10'}),
