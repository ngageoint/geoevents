...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field related_links on 'DirectorDashboard'
        m2m_table_name = db.shorten_name(u'director_directordashboard_related_links')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field related_links on 'DirectorDashboard'
        db.delete_table(db.shorten_name(u'director_directordashboard_related_links'))
