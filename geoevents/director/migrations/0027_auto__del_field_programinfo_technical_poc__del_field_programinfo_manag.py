...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgramInfo.technical_poc'
        db.delete_column(u'director_programinfo', 'technical_poc')

        # Deleting field 'ProgramInfo.management_poc'
        db.delete_column(u'director_programinfo', 'management_poc')

        # Adding field 'ProgramInfo.government_pm'
        db.add_column(u'director_programinfo', 'government_pm',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.government_cor'
        db.add_column(u'director_programinfo', 'government_cor',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.government_cotr'
        db.add_column(u'director_programinfo', 'government_cotr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.contractor'
        db.add_column(u'director_programinfo', 'contractor',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.contract_type'
        db.add_column(u'director_programinfo', 'contract_type',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.period_of_performance'
        db.add_column(u'director_programinfo', 'period_of_performance',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProgramObservation.trend_risk'
        db.delete_column(u'director_programobservation', 'trend_risk')

        # Deleting field 'ProgramObservation.summary_risk'
        db.delete_column(u'director_programobservation', 'summary_risk')

        # Deleting field 'ProgramObservation.metric_risk'
        db.delete_column(u'director_programobservation', 'metric_risk')

        # Adding field 'ProgramObservation.classification'
        db.add_column(u'director_programobservation', 'classification',
                      self.gf('django.db.models.fields.CharField')(default='Public Releasable', max_length=20),
                      keep_default=False)

        # Adding field 'ProgramObservation.pm_observation'
        db.add_column(u'director_programobservation', 'pm_observation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.metric_overall'
        db.add_column(u'director_programobservation', 'metric_overall',
                      self.gf('django.db.models.fields.CharField')(default='Yellow', max_length=10),
                      keep_default=False)

        # Adding field 'ProgramObservation.trend_overall'
        db.add_column(u'director_programobservation', 'trend_overall',
                      self.gf('django.db.models.fields.CharField')(default='Middle', max_length=10),
                      keep_default=False)

        # Adding field 'ProgramObservation.summary_overall'
        db.add_column(u'director_programobservation', 'summary_overall',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.budget_cost'
        db.add_column(u'director_programobservation', 'budget_cost',
                      self.gf('django.db.models.fields.TextField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.execution_cost'
        db.add_column(u'director_programobservation', 'execution_cost',
                      self.gf('django.db.models.fields.TextField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.funds_cost'
        db.add_column(u'director_programobservation', 'funds_cost',
                      self.gf('django.db.models.fields.TextField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.issues_performance'
        db.add_column(u'director_programobservation', 'issues_performance',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.risk_performance'
        db.add_column(u'director_programobservation', 'risk_performance',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProgramInfo.technical_poc'
        db.add_column(u'director_programinfo', 'technical_poc',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramInfo.management_poc'
        db.add_column(u'director_programinfo', 'management_poc',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProgramInfo.government_pm'
        db.delete_column(u'director_programinfo', 'government_pm')

        # Deleting field 'ProgramInfo.government_cor'
        db.delete_column(u'director_programinfo', 'government_cor')

        # Deleting field 'ProgramInfo.government_cotr'
        db.delete_column(u'director_programinfo', 'government_cotr')

        # Deleting field 'ProgramInfo.contractor'
        db.delete_column(u'director_programinfo', 'contractor')

        # Deleting field 'ProgramInfo.contract_type'
        db.delete_column(u'director_programinfo', 'contract_type')

        # Deleting field 'ProgramInfo.period_of_performance'
        db.delete_column(u'director_programinfo', 'period_of_performance')

        # Adding field 'ProgramObservation.trend_risk'
        db.add_column(u'director_programobservation', 'trend_risk',
                      self.gf('django.db.models.fields.CharField')(default='Middle', max_length=10),
                      keep_default=False)

        # Adding field 'ProgramObservation.summary_risk'
        db.add_column(u'director_programobservation', 'summary_risk',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProgramObservation.metric_risk'
        db.add_column(u'director_programobservation', 'metric_risk',
                      self.gf('django.db.models.fields.CharField')(default='Yellow', max_length=10),
                      keep_default=False)

        # Deleting field 'ProgramObservation.classification'
        db.delete_column(u'director_programobservation', 'classification')

        # Deleting field 'ProgramObservation.pm_observation'
        db.delete_column(u'director_programobservation', 'pm_observation')

        # Deleting field 'ProgramObservation.metric_overall'
        db.delete_column(u'director_programobservation', 'metric_overall')

        # Deleting field 'ProgramObservation.trend_overall'
        db.delete_column(u'director_programobservation', 'trend_overall')

        # Deleting field 'ProgramObservation.summary_overall'
        db.delete_column(u'director_programobservation', 'summary_overall')

        # Deleting field 'ProgramObservation.budget_cost'
        db.delete_column(u'director_programobservation', 'budget_cost')

        # Deleting field 'ProgramObservation.execution_cost'
        db.delete_column(u'director_programobservation', 'execution_cost')

        # Deleting field 'ProgramObservation.funds_cost'
        db.delete_column(u'director_programobservation', 'funds_cost')

        # Deleting field 'ProgramObservation.issues_performance'
        db.delete_column(u'director_programobservation', 'issues_performance')

        # Deleting field 'ProgramObservation.risk_performance'
        db.delete_column(u'director_programobservation', 'risk_performance')
    ...
    models = {
        ...
        u'director.programobservation': {
            ...
            'classification': ('django.db.models.fields.CharField', [], {'default': "'Public Releasable'", 'max_length': '20'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
