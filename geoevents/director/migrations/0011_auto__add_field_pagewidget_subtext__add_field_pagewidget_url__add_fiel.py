...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageWidget.subtext'
        db.add_column(u'director_pagewidget', 'subtext',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'PageWidget.url'
        db.add_column(u'director_pagewidget', 'url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PageWidget.icon'
        db.add_column(u'director_pagewidget', 'icon',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageWidget.subtext'
        db.delete_column(u'director_pagewidget', 'subtext')

        # Deleting field 'PageWidget.url'
        db.delete_column(u'director_pagewidget', 'url')

        # Deleting field 'PageWidget.icon'
        db.delete_column(u'director_pagewidget', 'icon')
    ...
    models = {
        ...
        u'director.pagewidget': {
            ...
            'subtext': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
