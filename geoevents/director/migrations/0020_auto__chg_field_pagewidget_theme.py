...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageWidget.theme'
        db.alter_column(u'director_pagewidget', 'theme', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'PageWidget.theme'
        db.alter_column(u'director_pagewidget', 'theme', self.gf('django.db.models.fields.CharField')(max_length=10))
