...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DirectorDashboard.url'
        db.delete_column(u'director_directordashboard', 'url')


    def backwards(self, orm):
        # Adding field 'DirectorDashboard.url'
        db.add_column(u'director_directordashboard', 'url',
