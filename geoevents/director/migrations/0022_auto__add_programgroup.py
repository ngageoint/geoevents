...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgramGroup'
        db.create_table(u'director_programgroup', (
        ...
        db.send_create_signal(u'director', ['ProgramGroup'])

        # Adding M2M table for field related_programs on 'ProgramGroup'
        m2m_table_name = db.shorten_name(u'director_programgroup_related_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('programgroup', models.ForeignKey(orm[u'director.programgroup'], null=False)),
            ('programinfo', models.ForeignKey(orm[u'director.programinfo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['programgroup_id', 'programinfo_id'])

        # Adding M2M table for field related_links on 'ProgramGroup'
        m2m_table_name = db.shorten_name(u'director_programgroup_related_links')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('programgroup', models.ForeignKey(orm[u'director.programgroup'], null=False)),
            ('link', models.ForeignKey(orm[u'director.link'], null=False))
        ))
        db.create_unique(m2m_table_name, ['programgroup_id', 'link_id'])

        # Removing M2M table for field related_programs on 'DirectorDashboard'
        db.delete_table(db.shorten_name(u'director_directordashboard_related_programs'))

        # Adding M2M table for field related_programgroups on 'DirectorDashboard'
        m2m_table_name = db.shorten_name(u'director_directordashboard_related_programgroups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('directordashboard', models.ForeignKey(orm[u'director.directordashboard'], null=False)),
            ('programgroup', models.ForeignKey(orm[u'director.programgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['directordashboard_id', 'programgroup_id'])


    def backwards(self, orm):
        # Deleting model 'ProgramGroup'
        db.delete_table(u'director_programgroup')

        # Removing M2M table for field related_programs on 'ProgramGroup'
        db.delete_table(db.shorten_name(u'director_programgroup_related_programs'))

        # Removing M2M table for field related_links on 'ProgramGroup'
        db.delete_table(db.shorten_name(u'director_programgroup_related_links'))

        # Adding M2M table for field related_programs on 'DirectorDashboard'
        m2m_table_name = db.shorten_name(u'director_directordashboard_related_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('directordashboard', models.ForeignKey(orm[u'director.directordashboard'], null=False)),
            ('programinfo', models.ForeignKey(orm[u'director.programinfo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['directordashboard_id', 'programinfo_id'])

        # Removing M2M table for field related_programgroups on 'DirectorDashboard'
        db.delete_table(db.shorten_name(u'director_directordashboard_related_programgroups'))
    ...
    models = {
        ...
        u'director.directordashboard': {
            ...
            'related_programgroups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['director.ProgramGroup']", 'null': 'True', 'blank': 'True'}),
