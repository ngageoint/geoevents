...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.posted_by'
        db.delete_column(u'director_report', 'posted_by')

        # Adding field 'Report.owner'
        db.add_column(u'director_report', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(max_length=250, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Report.posted_by'
        db.add_column(u'director_report', 'posted_by',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Report.owner'
        db.delete_column(u'director_report', 'owner_id')
