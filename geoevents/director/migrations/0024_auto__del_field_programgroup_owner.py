...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProgramGroup.owner'
        db.delete_column(u'director_programgroup', 'owner_id')


    def backwards(self, orm):
        # Adding field 'ProgramGroup.owner'
        db.add_column(u'director_programgroup', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], max_length=250, null=True, blank=True),
                      keep_default=False)
