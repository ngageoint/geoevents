...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.show_in_table'
        db.add_column(u'maps_layer', 'show_in_table',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Layer.url'
        db.alter_column(u'maps_layer', 'url', self.gf('django.db.models.fields.URLField')(max_length=600))

    def backwards(self, orm):
        # Deleting field 'Layer.show_in_table'
        db.delete_column(u'maps_layer', 'show_in_table')
    ...
    models = {
        ...
        u'maps.layer': {
            ...
            'show_in_table': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
