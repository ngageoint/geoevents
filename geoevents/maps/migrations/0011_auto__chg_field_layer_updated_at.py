...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layer.updated_at'
        db.alter_column(u'maps_layer', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Layer.updated_at'
        db.alter_column(u'maps_layer', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
