...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.spatial_reference'
        db.add_column('maps_layer', 'spatial_reference',
                      self.gf('django.db.models.fields.CharField')(default='EPSG:4326', max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.constraints'
        db.add_column('maps_layer', 'constraints',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.spatial_reference'
        db.delete_column('maps_layer', 'spatial_reference')

        # Deleting field 'Layer.constraints'
        db.delete_column('maps_layer', 'constraints')
