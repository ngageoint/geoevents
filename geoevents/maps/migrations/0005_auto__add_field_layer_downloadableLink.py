...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.downloadableLink'
        db.add_column('maps_layer', 'downloadableLink',
                      self.gf('django.db.models.fields.URLField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.downloadableLink'
        db.delete_column('maps_layer', 'downloadableLink')
