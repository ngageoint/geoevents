...
Geo-Events is a geographic knowledge management platform that gives users a common operational picture for tracking events such as hurricanes, tornadoes, floods, etc. through web services.  Geo-Events and [GeoQ] (https://github.com/ngageoint/geoq) can work together.    
