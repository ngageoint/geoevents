...
If you'd like to contribute to this project, please make a pull request. We'll review the pull request and discuss the changes. By submitting a pull request you are dedicating your work to the public domain.  You are free to fork this project and add unique elements with other stipulations in another repository or platform, but this living version shall remain free of restrictions within the public domain.  
